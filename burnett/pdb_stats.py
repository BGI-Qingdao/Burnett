...
def species_pdb_stats(species_dir):
    ...
    for fn in species_pdbs:
        struct = read_pdb(fn)
        total_mean_plddt.append(mean_ppdlt(struct))
        total_percet_plddt.append(proportion_ppdlt(struct))
...
if __name__ == '__main__':
    ...
    list_50 = [i for i in p_list if i >= 0.5]  # > 50 percent plddt is larger than 70
    list_70 = [i for i in m_list if i >= 70]  # mean plddt value is larger than 70
